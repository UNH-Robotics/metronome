...
out:
	...
	void readRows(const char *dataRoot, const char *levelFile) {
		...
		if(dom == "plat2d") {	
            ...
            attrs.push_back("moves", "Eight-way");
            attrs.push_back("prob", "0.45");
            attrs.push_back("width", "100");
            attrs.push_back("height", "100");
            ...
            dom = "traffic";
            attrs.push_back("type", "instance");
            attrs.push_back("width", "100");
            attrs.push_back("height", "100");
            attrs.push_back("obstacles", "5000");
